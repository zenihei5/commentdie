...
BACKUP_DIR = ROOT / "assets" / "source_backups" / "stream_start_waiting"
OUTPUT_DIR = ROOT / "assets" / "generated" / "stream_start_intro_ready_pc"
MANIFEST_PATH = OUTPUT_DIR / "senior_waiting_manifest.json"
QC_PATH = OUTPUT_DIR / "senior_waiting_qc.png"

ASSETS = {
    "aosumi_kyasumi": ("きゃすみ待機.png", "kyasumi_ready_pc.png"),
    "akarine_rizumu": ("りずむ待機.png", "rizumu_ready_pc.png"),
    "shizuki_miimu": ("みぃむ待機.png", "miimu_ready_pc.png"),
}
...
def main() -> None:
    ...
    print(f"processed {len(processed)} stream-start waiting assets")
    print(MANIFEST_PATH)
    print(QC_PATH)
