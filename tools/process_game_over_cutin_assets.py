...
BACKUP_DIR = ROOT / "assets" / "source_backups" / "game_over_cutin"
OUTPUT_DIR = ROOT / "assets" / "generated" / "game_over_intro_cutin_v1"
MANIFEST_PATH = OUTPUT_DIR / "senior_game_over_manifest.json"
QC_PATH = OUTPUT_DIR / "senior_game_over_qc.png"

ASSETS = {
    "aosumi_kyasumi": ("GOきゃすみ.png", "kyasumi_mental_intro.png"),
    "akarine_rizumu": ("GOりずむ.png", "rizumu_mental_intro.png"),
    "shizuki_miimu": ("GOみぃむ.png", "miimu_mental_intro.png"),
}
...
def main() -> None:
    ...
    print(f"processed {len(processed)} game-over cutin assets")
    print(MANIFEST_PATH)
    print(QC_PATH)
